      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="card-hover">
            ...
            <CardContent>
              ...
              <p className={`text-xs mt-1 flex items-center gap-1 ${
                dailyOrderMetrics.changePercentage >= 0 ? "text-success" : "text-destructive"
              }`}>
          ...
          <Card className="card-hover">
            ...
            <CardContent>
              ...
              <p className={`text-xs mt-1 flex items-center gap-1 ${
                dailyOrderMetrics.valueChangePercentage >= 0 ? "text-success" : "text-destructive"
              }`}>
              ...
              <div className="space-y-4">
                ...
                <div className="pt-2 border-t">
                  <p className={`text-xs flex items-center gap-1 ${
                    totalInventoryValue.changePercentage >= 0 ? "text-success" : "text-destructive"
                  }`}>
